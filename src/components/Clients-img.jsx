    ...
    <section className="Clients-img-section">
      ...
      <div className="clients-rows-container">
        {rows.map((rowLogos, rowIndex) => (
          <div key={rowIndex} className="clients-row-swiper-wrapper">
            <Swiper
              slidesPerView={1}
              spaceBetween={0}
              loop={true}
              autoplay={{
                delay: 3000 + rowIndex * 1000, // Staggered delays
                disableOnInteraction: false,
                reverseDirection: rowIndex % 2 !== 0, // Alternate direction
              }}
              breakpoints={{
                640: { slidesPerView: 2 },
                768: { slidesPerView: 3 },
                1024: { slidesPerView: 4 }, // 4 Columns as requested
              }}
              modules={[Autoplay]}
              className="clients-row-swiper"
            >
