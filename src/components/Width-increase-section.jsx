import "../css/Width-increase-section.css";
...
export default function WidthIncreaseSection({ bgImage }) {
  ...
  return (
    <section ref={sectionRef} className="wa-width-increase-section">
      <div
        ref={contentRef}
        className="wa-width-increase-content"
        style={{ backgroundImage: `url(${bgImage})` }}
      />
      <div
        className="wa-width-increase-overlay"
        style={{
          opacity: 0,
