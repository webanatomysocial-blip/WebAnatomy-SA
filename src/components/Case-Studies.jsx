      ...
      <section className="home-case-studies-section">
        ...
        <div className="Home-case-studies-container">
          {caseStudiesData.map((item) => {
            return (
              <div key={item.id} className="Home-case-studies-item">
                <div className="Home-case-studies-item-img">
                  <img src={item.img} alt={item.title} />
                </div>
                <div className="Home-case-studies-item-text">
              ...
              <div className="case-studies-btn-container">
          <a href="/" className="white-bg-btn">
            Our Works <GoArrowRight className="arrow-icon" />
          </a>
      </div>
      </section>
    </>
