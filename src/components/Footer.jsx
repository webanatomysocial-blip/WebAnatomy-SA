    ...
    <footer className="footer-container">
      <div className="footer-wrapper">
        ...
        <div className="footer-links-grid">
          ...
          <div className="footer-column">
            ...
            <ul>
              ...
              <li>
                <Link to="/awards">Awards and Recognitions</Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/resource-augmentation">Resource Augmentation</Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/feedback">Submit Feedback to Our CEO</Link>
              </li>
              <li>
          ...
          <div className="footer-column-connect">
            ...
            <ul>
              <li className="contact-row">
                ...
                <span className="contact-val">: +91 999 999 9999</span>
              </li>
              <li className="contact-row">
        ...
        <div className="footer-bottom">
          <div>WebAnatomy © {currentYear} All rights reserved</div>
